...
test-xfail-test-float32-float128-div = yes
test-xfail-test-float32-float128-fma = yes
test-xfail-test-float32-float128-mul = yes
...
test-xfail-test-float32-float64x-div = yes
test-xfail-test-float32-float64x-fma = yes
test-xfail-test-float32-float64x-mul = yes
test-xfail-test-float32-float64x-sub = yes
test-xfail-test-float32-fma = yes
test-xfail-tst-clock_nanosleep2 = yes
test-xfail-tst-tcfree1-malloc-check = yes
test-xfail-tst-tcfree2-malloc-check = yes
endif
